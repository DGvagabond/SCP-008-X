...
namespace SCP008X
{
    ...
    public sealed class Config : IConfig
    {
        ...
        [Description("008 zombie starting Ahp (Shield).")]
        ...
        [Description("How much damage 008 zombies do per hit.")]
        ...
        [Description("How long, in seconds, will SCP-049 be able to sense?")]
        public int SenseDuration { get; set; } = 20;
        [Description("How long, in seconds, can SCP-049 be seen by zombies")]
        public int CallDuration { get; set; } = 20;
    }
}